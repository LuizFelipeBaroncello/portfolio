...
export const GRID_LAYOUTS = {
  lg: [
    ...
    { i: 'blog', x: 3, y: 4, w: 4, h: 2 },
    { i: 'wrapso', x: 7, y: 4, w: 5, h: 2 },
    { i: 'social', x: 9, y: 3, w: 3, h: 1 },
  ],
  md: [
    ...
    { i: 'blog', x: 0, y: 7, w: 4, h: 2 },
    { i: 'social', x: 4, y: 8, w: 4, h: 1 },
  ],
  sm: [
    { i: 'bio', x: 0, y: 0, w: 4, h: 2 },
    ...
    { i: 'blog', x: 0, y: 12, w: 4, h: 2 },
    { i: 'newsletter', x: 0, y: 14, w: 4, h: 2 },
    { i: 'twitter', x: 0, y: 16, w: 4, h: 1 },
    { i: 'social', x: 0, y: 17, w: 4, h: 1 },
  ],
}
